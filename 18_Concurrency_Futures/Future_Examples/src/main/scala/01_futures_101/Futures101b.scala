...
/**
  * These are some examples that show different ways to import an
  * ExecutionContext. They are from Hermann Hueck, a reviewer of the
  * 2nd Edition of the Scala Cookbook.
  */
